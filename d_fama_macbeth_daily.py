...
fama_macbeth_aic.to_csv(r'Outputs\fama_macbeth_aic_daily.csv')
fama_macbeth_bic.to_csv(r'Outputs\fama_macbeth_bic_daily.csv')
fama_macbeth_market_tvals.to_csv(r'Outputs\fama_macbeth_market_tvals_daily.csv')
fama_macbeth_beta_tvals.to_csv(r'Outputs\fama_macbeth_beta_tvals_daily.csv')
fama_macbeth_fstat.to_csv(r'Outputs\fama_macbeth_fstat_daily.csv')
