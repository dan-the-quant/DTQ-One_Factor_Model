...
stock_returns = pd.read_csv(r'Inputs/weekly_returns.csv')
stock_returns.set_index('Date', inplace=True)
stock_returns.index = pd.to_datetime(stock_returns.index)

benchmark_returns = pd.read_csv(r'Inputs/benchmark_returns_weekly.csv')
...
hedging_summary.to_csv(r'Outputs\hedging_tests_weekly.csv')