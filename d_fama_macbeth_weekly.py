...
stock_log_returns = pd.read_csv(r'Inputs\weekly_returns.csv', index_col='Date')
stock_log_returns.index = pd.to_datetime(stock_log_returns.index)

stock_excess_returns = pd.read_csv(r'Inputs\weekly_excess_returns.csv', index_col='Date')
stock_excess_returns.index = pd.to_datetime(stock_excess_returns.index)

# Rolling Sigmas
rolling_sigmas = stock_log_returns.rolling(window=52).var()
rolling_sigmas = rolling_sigmas.iloc[51:]
...
def load_beta_group(prefix):
    return {w: load_betas(f'Betas/{prefix}_{w}w.csv') for w in windows}
...
fama_macbeth_market_factor.to_csv(r'Outputs\fama_macbeth_market_factor_weekly.csv')
fama_macbeth_beta_factor.to_csv(r'Outputs\fama_macbeth_beta_factor_weekly.csv')
fama_macbeth_r2.to_csv(r'Outputs\fama_macbeth_r2_weekly.csv')
fama_macbeth_aic.to_csv(r'Outputs\fama_macbeth_aic_weekly.csv')
fama_macbeth_bic.to_csv(r'Outputs\fama_macbeth_bic_weekly.csv')
fama_macbeth_market_tvals.to_csv(r'Outputs\fama_macbeth_market_tvals_weekly.csv')
fama_macbeth_beta_tvals.to_csv(r'Outputs\fama_macbeth_beta_tvals_weekly.csv')
fama_macbeth_fstat.to_csv(r'Outputs\fama_macbeth_fstat_weekly.csv')
